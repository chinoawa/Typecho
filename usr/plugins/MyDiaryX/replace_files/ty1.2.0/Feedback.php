...
class Feedback extends Comments implements ActionInterface
{
    ...
    private function comment()
    {
        ...
        /** 添加评论 */
        $comment['weather'] = $this->request->get('weather');
        $comment['temperature'] = $this->request->get('temperature');
        $comment['secert'] = $this->request->get('secert');
        $comment['mood'] = $this->request->get('mood');
        $comment['image'] = $this->request->get('image');
